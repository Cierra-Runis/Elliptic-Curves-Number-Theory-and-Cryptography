...
这就是我们在推导椭圆曲线上点加自身的运算公式时使用的仿射坐标下的切线。现在我们来看这条曲线上的无穷远点。我们有 $(x_0 : y_0 : z_0) = (0 : 1 :0)$，该点处切线由 $0x + 0y + z = 0$ 给出，也就是射影平面 $PP_K^2$ 中的“无穷远直线”。这条直线仅在点 $(0 : 1 : 0)$ 处与曲线相交，这与椭圆曲线上 $infinity + infinity = infinity$ 这一事实相对应。
